...
let myArmies = [
  ...
  ['alfil wazir zebra antelope', 'black red blue yellow green', '0100 1110 0110 1000'],
  ...
  ['antelope ferz gecko', 'white red blue lime', '010 001 110'],
  ['antelope giraffe dabbaba', 'white blue black gold'],
  ['antelope giraffe giraffe', 'white purple black cyan'],
  ['antelope knight knight commuter', 'white black yellow lime blue', '0100 0111 0011 0001'],
  ...
  ['camel ferz giraffe gecko', 'white lime yellow blue red', '1100 1001 1101 1010'],
  ...
  ['commuter knight giraffe', 'white black yellow red', '010 110 001'],
  ...
  ['dromedary ferz camel', 'white red yellow blue', '101 100 110'],
  ...
  ['ferz dabbaba zebra', 'black red blue lime', '011 110 110'],
  ['ferz giraffe eland knight', 'white red orange cyan lime', '0100 0111 1100 1110'],
  ['ferz stag alfil', 'white black red blue', '001 100 011'],
  ['ferz wazir stag zebra camel', 'white red blue lime purple orange'],
  ['ferz zebra ferz antelope', 'black yellow red cyan lime', '0100 1001 0111 0110'],
  ...
  ['knight commuter zebra antelope', 'yellow black red blue orange', '1101 0001 0101 1010'],
  ...
  ['knight giraffe eland ferz', 'white red yellow blue lime', '0100 0011 0101 1110'],
  ['knight stag stag wazir', 'black red gold pink cyan'],
  ['knight wazir antelope knight', 'white red green purple blue'],
  ['knight zebra dromedary stag', 'white red blue lime gold', '0011 1011 0101 0110'],
  ['knight zebra eland', 'white red blue lime'],
  ['stag', 'black red'],
  ['stag antelope knight antelope', 'black yellow orange red gold', '0010 1001 0100 1010'],
  ...
  ['zebra commuter alfil', 'white black lime gold', '001 010 101'],
  ['zebra ferz dromedary dabbaba', 'white red blue yellow pink'],
  ['zebra ferz stag zebra', 'white yellow cyan lime purple', '0001 1110 1000 1110'],
